...
function s2() {
  if (Z1)
    return E;
  Z1 = 1;
  var r = j1, l = Symbol.for("react.element"), t = Symbol.for("react.fragment"), j = Object.prototype.hasOwnProperty, b = r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, D = { key: !0, ref: !0, __self: !0, __source: !0 };
  function F(v, h, m) {
    var f, x = {}, Z = null, W = null;
    m !== void 0 && (Z = "" + m), h.key !== void 0 && (Z = "" + h.key), h.ref !== void 0 && (W = h.ref);
    for (f in h)
      j.call(h, f) && !D.hasOwnProperty(f) && (x[f] = h[f]);
    if (v && v.defaultProps)
      for (f in h = v.defaultProps, h)
        x[f] === void 0 && (x[f] = h[f]);
    return { $$typeof: l, type: v, key: Z, ref: W, props: x, _owner: b.current };
  }
  return E.Fragment = t, E.jsx = F, E.jsxs = F, E;
}
var N = {};
/**
 * @license React
...
function n2() {
  return g1 || (g1 = 1, process.env.NODE_ENV !== "production" && function() {
    var r = j1, l = Symbol.for("react.element"), t = Symbol.for("react.portal"), j = Symbol.for("react.fragment"), b = Symbol.for("react.strict_mode"), D = Symbol.for("react.profiler"), F = Symbol.for("react.provider"), v = Symbol.for("react.context"), h = Symbol.for("react.forward_ref"), m = Symbol.for("react.suspense"), f = Symbol.for("react.suspense_list"), x = Symbol.for("react.memo"), Z = Symbol.for("react.lazy"), W = Symbol.for("react.offscreen"), X = Symbol.iterator, m1 = "@@iterator";
    function k1(e) {
    ...
    function u(e) {
      {
        for (var i = arguments.length, H = new Array(i > 1 ? i - 1 : 0), s = 1; s < i; s++)
          H[s - 1] = arguments[s];
        R1("error", e, H);
      }
    }
    function R1(e, i, H) {
      {
        ...
        d !== "" && (i += "%s", H = H.concat([d]));
        var a = H.map(function(o) {
          return String(o);
        });
        a.unshift("Warning: " + i), Function.prototype.apply.call(console[e], console, a);
      }
    }
    var y1 = !1, F1 = !1, B1 = !1, _1 = !1, E1 = !1, Q;
    Q = Symbol.for("react.module.reference");
    function N1(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === j || e === D || E1 || e === b || e === m || e === f || _1 || e === W || y1 || F1 || B1 || typeof e == "object" && e !== null && (e.$$typeof === Z || e.$$typeof === x || e.$$typeof === F || e.$$typeof === v || e.$$typeof === h || // This needs to include all possible module reference object
    ...
    function w(e) {
      ...
      if (typeof e == "object")
        switch (e.$$typeof) {
          case v:
            var i = e;
            return C1(i) + ".Consumer";
          case F:
            var H = e;
            return C1(H._context) + ".Provider";
          case h:
          ...
          case Z: {
            var d = e, a = d._payload, o = d._init;
            try {
              return w(o(a));
            } catch (n) {
              return null;
    ...
    var g = Object.assign, B = 0, e1, l1, t1, r1, i1, H1, s1;
    function n1() {
    }
...
` + n[L].replace(" at new ", " at ");
                    return e.displayName && V.includes("<anonymous>") && (V = V.replace("<anonymous>", e.displayName)), typeof e == "function" && S.set(e, V), V;
                  }
                while (L >= 1 && c >= 0);
              break;
            }
        ...
        U = !1, q.current = a, W1(), Error.prepareStackTrace = d;
      }
      var y = e ? e.displayName || e.name : "", v1 = y ? A(y) : "";
      return typeof e == "function" && S.set(e, v1), v1;
    }
    function S1(e, i, H) {
      return o1(e, !1);
    }
      ...
      if (typeof e == "object")
        switch (e.$$typeof) {
          ...
          case x:
            return T(e.type, i, H);
          case Z: {
            var s = e, d = s._payload, a = s._init;
            try {
              return T(a(d), i, H);
            } catch (o) {
            }
    ...
    var O = Object.prototype.hasOwnProperty, d1 = {}, a1 = k.ReactDebugCurrentFrame;
    function P(e) {
      if (e) {
        var i = e._owner, H = T(e.type, e._source, i ? i.type : null);
        a1.setExtraStackFrame(H);
      } else
        a1.setExtraStackFrame(null);
    }
    function O1(e, i, H, s, d) {
      {
        var a = Function.call.bind(O);
        for (var o in e)
          if (a(e, o)) {
            var n = void 0;
            try {
              if (typeof e[o] != "function") {
                var p = Error((s || "React class") + ": " + H + " type `" + o + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof e[o] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw p.name = "Invariant Violation", p;
              }
              n = e[o](i, o, s, H, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (L) {
              n = L;
            }
            n && !(n instanceof Error) && (P(d), u("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", s || "React class", H, o, typeof n), P(null)), n instanceof Error && !(n.message in d1) && (d1[n.message] = !0, P(d), u("Failed %s type: %s", H, n.message), P(null));
          }
      }
    }
    ...
    function q1(e) {
      {
        var i = typeof Symbol == "function" && Symbol.toStringTag, H = i && e[Symbol.toStringTag] || e.constructor.name || "Object";
        return H;
      }
    }
    function I1(e) {
    ...
    function G1(e, i) {
      if (typeof e.ref == "string" && _.current && i && _.current.stateNode !== i) {
        var H = w(_.current.type);
        Y[H] || (u('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', w(_.current.type), e.ref), Y[H] = !0);
      }
    }
    function J1(e, i) {
      {
        var H = function() {
          h1 || (h1 = !0, u("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", i));
        };
    ...
    function K1(e, i) {
      {
        var H = function() {
          u1 || (u1 = !0, u("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", i));
        };
    ...
    function X1(e, i, H, s, d) {
      {
        var a, o = {}, n = null, p = null;
        H !== void 0 && (c1(H), n = "" + H), Y1(i) && (c1(i.key), n = "" + i.key), $1(i) && (p = i.ref, G1(i, d));
        for (a in i)
          O.call(i, a) && !U1.hasOwnProperty(a) && (o[a] = i[a]);
        if (e && e.defaultProps) {
        ...
        return z1(e, n, p, d, s, _.current, o);
      }
    }
    var G = k.ReactCurrentOwner, p1 = k.ReactDebugCurrentFrame;
    function R(e) {
      if (e) {
        var i = e._owner, H = T(e.type, e._source, i ? i.type : null);
        p1.setExtraStackFrame(H);
      } else
    ...
    function x1(e, i) {
      {
        ...
        V1[H] = !0;
        var s = "";
        e && e._owner && e._owner !== G.current && (s = " It was passed a child from " + w(e._owner.type) + "."), R(e), u('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', H, s), R(null);
      }
    }
    function w1(e, i) {
      {
        ...
        if ($(e))
          ...
          if (typeof d == "function" && d !== e.entries)
            for (var a = d.call(e), o; !(o = a.next()).done; )
              K(o.value) && x1(o.value, i);
        }
      }
    }
    function e2(e) {
    ...
    function l2(e) {
      {
        for (var i = Object.keys(e.props), H = 0; H < i.length; H++) {
          var s = i[H];
          if (s !== "children" && s !== "key") {
            R(e), u("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", s), R(null);
            break;
          }
        }
    ...
    function M1(e, i, H, s, d, a) {
      {
        ...
        if (!o) {
          ...
          p ? n += p : n += f1();
          var L;
          e === null ? L = "null" : $(e) ? L = "array" : e !== void 0 && e.$$typeof === l ? (L = "<" + (w(e.type) || "Unknown") + " />", n = " Did you accidentally export a JSX literal instead of a component?") : L = typeof e, u("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", L, n);
        }
        var c = X1(e, i, H, d, a);
        if (c == null)
          return c;
...
process.env.NODE_ENV === "production" ? z.exports = s2() : z.exports = n2();
var C = z.exports;
const o2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    width: r,
    height: l,
    ...
    children: [
      ...
      /* @__PURE__ */ C.jsx("path", { d: "M14.3711 6.09217V6.0332", stroke: t, strokeWidth: "2", strokeLinecap: "square" }),
      /* @__PURE__ */ C.jsx("circle", { cx: "12.0001", cy: "12.002", r: "2.45515", stroke: t, strokeWidth: "2" })
    ]
  }
);
o2.displayName = "Zp";
...
const a2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
const L2 = ({
  ...
  "svg",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ C.jsx("path", { d: "M13.5986 11.9229H18.7525", stroke: t, strokeWidth: "2", strokeMiterlimit: "10" }),
      /* @__PURE__ */ C.jsx(
        "path",
        {
...
const c2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
f2.displayName = "CurrencyRuble";
const V2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    width: r,
    height: l,
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      /* @__PURE__ */ C.jsx("mask", { id: "path-1-inside-1_4288_8258", fill: "white", children: /* @__PURE__ */ C.jsx(
        "path",
        {
          fillRule: "evenodd",
          clipRule: "evenodd",
...
const x2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
const w2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
const M2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
M2.displayName = "Online";
const v2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
Z2.displayName = "SendCard";
const g2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
const k2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
const F2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
const B2 = ({
  ...
  "svg",
  {
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      /* @__PURE__ */ C.jsx("mask", { id: "path-1-inside-1_2769_3723", fill: "white", children: /* @__PURE__ */ C.jsx(
        "path",
        {
          fillRule: "evenodd",
          clipRule: "evenodd",
          d: "M4.41465 8C4.264 8.42621 3.92621 8.764 3.5 8.91465V15.0854C3.92621 15.236 4.26401 15.5738 4.41465 16H19.5854C19.736 15.5738 20.0738 15.236 20.5 15.0854V8.91465C20.0738 8.764 19.736 8.42621 19.5854 8H4.41465ZM22.4913 16.3371C22.497 16.2777 22.5 16.2174 22.5 16.1565V7.84355C22.5 7.78259 22.497 7.72232 22.4913 7.66288C22.497 7.60937 22.5 7.55504 22.5 7.5C22.5 6.67157 21.8284 6 21 6C20.945 6 20.8906 6.00296 20.8371 6.00874C20.7777 6.00296 20.7174 6 20.6565 6H3.34355C3.28259 6 3.22232 6.00296 3.16288 6.00874C3.10938 6.00296 3.05503 6 3 6C2.17157 6 1.5 6.67157 1.5 7.5C1.5 7.55503 1.50296 7.60938 1.50874 7.66288C1.50296 7.72232 1.5 7.78259 1.5 7.84355V16.1565C1.5 16.2174 1.50296 16.2777 1.50874 16.3371C1.50296 16.3906 1.5 16.445 1.5 16.5C1.5 17.3284 2.17157 18 3 18C3.05503 18 3.10938 17.997 3.16288 17.9913C3.22232 17.997 3.28259 18 3.34355 18H20.6565C20.7174 18 20.7777 17.997 20.8371 17.9913C20.8906 17.997 20.945 18 21 18C21.8284 18 22.5 17.3284 22.5 16.5C22.5 16.445 22.497 16.3906 22.4913 16.3371ZM6 13.125C6.62132 13.125 7.125 12.6213 7.125 12C7.125 11.3787 6.62132 10.875 6 10.875C5.37868 10.875 4.875 11.3787 4.875 12C4.875 12.6213 5.37868 13.125 6 13.125ZM19.125 12C19.125 12.6213 18.6213 13.125 18 13.125C17.3787 13.125 16.875 12.6213 16.875 12C16.875 11.3787 17.3787 10.875 18 10.875C18.6213 10.875 19.125 11.3787 19.125 12ZM13 12C13 12.5523 12.5523 13 12 13C11.4477 13 11 12.5523 11 12C11 11.4477 11.4477 11 12 11C12.5523 11 13 11.4477 13 12ZM15 12C15 13.6569 13.6569 15 12 15C10.3431 15 9 13.6569 9 12C9 10.3431 10.3431 9 12 9C13.6569 9 15 10.3431 15 12Z"
        }
      ) }),
      /* @__PURE__ */ C.jsx(
        "path",
      ...
      /* @__PURE__ */ C.jsx(
        "path",
        {
          d: "M3.5 8.91465L2.83351 7.02897L1.5 7.50029V8.91465H3.5ZM4.41465 8V6H3.0003L2.52897 7.33351L4.41465 8ZM3.5 15.0854H1.5V16.4997L2.83351 16.971L3.5 15.0854ZM4.41465 16L2.52897 16.6665L3.0003 18H4.41465V16ZM19.5854 16V18H20.9997L21.471 16.6665L19.5854 16ZM20.5 15.0854L21.1665 16.971L22.5 16.4997V15.0854H20.5ZM20.5 8.91465H22.5
.4477 11.4477 11 12 11V15ZM9 12C9 13.6569 10.3431 15 12 15V11C12.5523 11 13 11.4477 13 12H9ZM12 9C10.3431 9 9 10.3431 9 12H13C13 12.5523 12.5523 13 12 13V9ZM15 12C15 10.3431 13.6569 9 12 9V13C11.4477 13 11 12.5523 11 12H15ZM12 17C14.7614 17 17 14.7614 17 12H13C13 12.5523 12.5523 13 12 13V17ZM7 12C7 14.7614 9.23858 17 12 17V13C11.4477 13 11 12.5523 11 12H7ZM12 7C9.23858 7 7 9.23858 7 12H11C11 11.4477 11.4477 11 12 11V7ZM17 12C17 9.23858 14.7614 7 12 7V11C12.5523 11 13 11.4477 13 12H17Z",
          fill: t,
          mask: "url(#path-1-inside-1_2769_3723)"
        }
      )
    ]
  }
);
B2.displayName = "Banknote";
const _2 = ({
  width: r = "25",
  height: l = "25",
  color: t = "currentColor"
  ...
  "svg",
  {
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      /* @__PURE__ */ C.jsx("mask", { id: "path-1-inside-1_2769_3745", fill: "white", children: /* @__PURE__ */ C.jsx(
        "path",
        {
          fillRule: "evenodd",
          clipRule: "evenodd",
          d: "M8.07982 6H3.34355C3.28259 6 3.22232 6.00296 3.16288 6.00874C3.10938 6.00296 3.05503 6 3 6C2.17157 6 1.5 6.67157 1.5 7.5C1.5 7.55503 1.50296 7.60938 1.50874 7.66288C1.50296 7.72232 1.5 7.78259 1.5 7.84355V16.1565C1.5 16.2174 1.50296 16.2777 1.50874 16.3371C1.50296 16.3906 1.5 16.445 1.5 16.5C1.5 17.3284 2.17157 18 3 18C3.05503 18 3.10938 17.997 3.16288 17.9913C3.22232 17.997 3.28259 18 3.34355 18H12.5093L11.7711 16H4.41465C4.26401 15.5738 3.92621 15.236 3.5 15.0854V8.91465C3.92621 8.764 4.264 8.42621 4.41465 8H8.81807L8.07982 6ZM9.62022 10.1731C9.23125 10.679 9 11.3125 9 12C9 13.4436 10.0197 14.6491 11.3781 14.9355L9.62022 10.1731ZM14.0756 14.1661L12.1704 9.00476C13.748 9.09309 15 10.4003 15 12C15 12.8515 14.6453 13.6201 14.0756 14.1661ZM14.7525 16H19.5854C19.736 15.5738 20.0738 15.236 20.5 15.0854V8.91465C20.0738 8.764 19.736 8.42621 19.5854 8H11.7995L11.0613 6H20.6565C20.7174 6 20.7777 6.00296 20.8371 6.00874C20.8906 6.00296 20.945 6 21 6C21.8284 6 22.5 6.67157 22.5 7.5C22.5 7.55504 22.497 7.60937 22.4913 7.66288C22.497 7.72232 22.5 7.78259 22.5 7.84355V16.1565C22.5 16.2174 22.497 16.2777 22.4913 16.3371C22.497 16.3906 22.5 16.445 22.5 16.5C22.5 17.3284 21.8284 18 21 18C20.945 18 20.8906 17.997 20.8371 17.9913C20.7777 17.997 20.7174 18 20.6565 18H15.4908L14.7525 16ZM7.125 12C7.125 12.6213 6.62132 13.125 6 13.125C5.37868 13.125 4.875 12.6213 4.875 12C4.875 11.3787 5.37868 10.875 6 10.875C6.62132 10.875 7.125 11.3787 7.125 12ZM18 13.125C18.6213 13.125 19.125 12.6213 19.125 12C19.125 11.3787 18.6213 10.875 18 10.875C17.3787 10.875 16.875 11.3787 16.875 12C16.875 12.6213 17.3787 13.125 18 13.125Z"
        }
      ) }),
      /* @__PURE__ */ C.jsx(
        "path",
      ...
      /* @__PURE__ */ C.jsx(
        "path",
        {
          d: "
H19.5854V6ZM9.18501 6.69257L9.92326 8.69257L13.6758 7.30743L12.9375 5.30743L9.18501 6.69257ZM20.6565 4H11.0613V8H20.6565V4ZM21.0307 4.01813C20.9071 4.0061 20.7822 4 20.6565 4V8C20.6527 8 20.6483 7.99981 20.6435 7.99935L21.0307 4.01813ZM21 4C20.8731 4 20.7471 4.00684 20.6224 4.0203L21.0518 7.99718C21.0342 7.99909 21.0168 8 21 8V4ZM24.5 7.5C24.5 5.567 22.933 4 21 4V8C20.7239 8 20.5 7.77614 20.5 7.5H24.5ZM24.4797 7.87759C24.4932 7.75292 24.5 7.62691 24.5 7.5H20.5C20.5 7.48316 20.5009 7.46582 20.5028 7.44816L24.4797 7.87759ZM24.5 7.84355C24.5 7.7178 24.4939 7.59292 24.4819 7.46928L20.5007 7.85647C20.5002 7.85171 20.5 7.84737 20.5 7.84355H24.5ZM24.5 16.1565V7.84355H20.5V16.1565H24.5ZM24.4819 16.5307C24.4939 16.4071 24.5 16.2822 24.5 16.1565H20.5C20.5 16.1526 20.5002 16.1483 20.5007 16.1435L24.4819 16.5307ZM24.5 16.5C24.5 16.3731 24.4932 16.2471 24.4797 16.1224L20.5028 16.5518C20.5009 16.5342 20.5 16.5168 20.5 16.5H24.5ZM21 20C22.933 20 24.5 18.433 24.5 16.5H20.5C20.5 16.2239 20.7239 16 21 16V20ZM20.6224 19.9797C20.7471 19.9932 20.8731 20 21 20V16C21.0168 16 21.0342 16.0009 21.0518 16.0028L20.6224 19.9797ZM20.6565 20C20.7822 20 20.907 19.9939 21.0308 19.9819L20.6435 16.0007C20.6483 16.0002 20.6527 16 20.6565 16V20ZM15.4908 20H20.6565V16H15.4908V20ZM12.8763 16.6926L13.6145 18.6926L17.367 17.3074L16.6288 15.3074L12.8763 16.6926ZM6 15.125C7.72589 15.125 9.125 13.7259 9.125 12H5.125C5.125 11.5168 5.51675 11.125 6 11.125V15.125ZM2.875 12C2.875 13.7259 4.27411 15.125 6 15.125V11.125C6.48325 11.125 6.875 11.5168 6.875 12H2.875ZM6 8.875C4.27411 8.875 2.875 10.2741 2.875 12H6.875C6.875 12.4832 6.48325 12.875 6 12.875V8.875ZM9.125 12C9.125 10.2741 7.72589 8.875 6 8.875V12.875C5.51675 12.875 5.125 12.4832 5.125 12H9.125ZM17.125 12C17.125 11.5168 17.5168 11.125 18 11.125V15.125C19.7259 15.125 21.125 13.7259 21.125 12H17.125ZM18 12.875C17.5168 12.875 17.125 12.4832 17.125 12H21.125C21.125 10.2741 19.7259 8.875 18 8.875V12.875ZM18.875 12C18.875 12.4832 18.4832 12.875 18 12.875V8.875C16.2741 8.875 14.875 10.2741 14.875 12H18.875ZM18 11.125C18.4832 11.125 18.875 11.5168 18.875 12H14.875C14.875 13.7259 16.2741 15.125 18 15.125V11.125Z",
          fill: t,
          mask: "url(#path-1-inside-1_2769_3745)"
        }
      ),
      /* @__PURE__ */ C.jsx("line", { x1: "7.93544", y1: "3.64653", x2: "14.1566", y2: "20.1103", stroke: t, strokeWidth: "2" })
    ]
  }
);
_2.displayName = "CrossedBanknote";
const E2 = ({
  width: r = "25",
  height: l = "25",
  color: t = "currentColor"
...
E2.displayName = "ArrowDown";
const N2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
I2.displayName = "ChevronLeftSmall";
const U2 = ({
  width: r = "25",
  height: l = "25",
  color: t = "currentColor"
...
G2.displayName = "EyeOff";
const J2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
K2.displayName = "Search";
const z2 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
z2.displayName = "Bill";
const X2 = ({ width: r = "24", height: l = "24", color: t = "currentColor" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: r,
...
const C5 = ({ width: r = "24", height: l = "24", color: t = "currentColor" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: r,
...
e5.displayName = "Subscription";
const l5 = ({ width: r = "24", height: l = "24", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: r,
...
t5.displayName = "Calendar";
const r5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
r5.displayName = "Chat";
const i5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
i5.displayName = "Check";
const H5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
H5.displayName = "Clock";
const s5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    width: r,
    height: l,
...
s5.displayName = "Close";
const n5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
n5.displayName = "Copy";
const o5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
o5.displayName = "Delete";
const d5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
a5.displayName = "DocEmpty";
const L5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
L5.displayName = "Edit";
const c5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
p5.displayName = "HelpCircle";
const f5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
f5.displayName = "Home";
const V5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
const x5 = ({
  ...
  "svg",
  {
    ...
    fill: "none",
    children: [
      /* @__PURE__ */ C.jsx("circle", { cx: "8", cy: "8", r: "8", fill: t }),
      /* @__PURE__ */ C.jsx("path", { d: "M8 11.8L8 7", stroke: "white", strokeWidth: "1.5", strokeLinejoin: "round" }),
      /* @__PURE__ */ C.jsx("path", { d: "M8 6L8 4.2", stroke: "white", strokeWidth: "1.5", strokeLinejoin: "round" })
    ]
  }
);
x5.displayName = "InfoContained";
const w5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
v5.displayName = "Lock";
const Z5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
Z5.displayName = "Mail";
const g5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
g5.displayName = "MapPin";
const j5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    width: r,
    height: l,
...
j5.displayName = "Menu";
const m5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
m5.displayName = "Move";
const k5 = ({ width: r = "24", height: l = "24", color: t = "currentColor" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: r,
    ...
    strokeLinejoin: "round",
    children: [
      /* @__PURE__ */ C.jsx("path", { d: "M11 12C11 12.5523 11.4477 13 12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12Z" }),
      /* @__PURE__ */ C.jsx("path", { d: "M11 19C11 19.5523 11.4477 20 12 20C12.5523 20 13 19.5523 13 19C13 18.4477 12.5523 18 12 18C11.4477 18 11 18.4477 11 19Z" }),
      /* @__PURE__ */ C.jsx("path", { d: "M11 5C11 5.55228 11.4477 6 12 6C12.5523 6 13 5.55228 13 5C13 4.44772 12.5523 4 12 4C11.4477 4 11 4.44772 11 5Z" })
    ]
  }
);
k5.displayName = "More";
...
F5.displayName = "PlusRect";
const B5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    width: r,
    height: l,
...
_5.displayName = "RefreshCw";
const E5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
W5.displayName = "Star";
const A5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
A5.displayName = "Tune";
const S5 = ({ width: r = "25", height: l = "25", color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
...
S5.displayName = "Unlock";
const T5 = ({ width: r = "24", height: l = "24", color: t = "currentColor" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: r,
...
T5.displayName = "Bell";
const O5 = ({ width: r = 24, height: l = 24, color: t = "currentColor" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: r,
    ...
    children: /* @__PURE__ */ C.jsx(
      "path",
      {
        fillRule: "evenodd",
        clipRule: "evenodd",
),
      /* @__PURE__ */ C.jsx(
        "path",
        {
          fillRule: "evenodd",
...
const I5 = ({
  ...
  "svg",
  {
    ...
    children: /* @__PURE__ */ C.jsx(
      "path",
      {
        d: "M12 30C12.5523 30 13 29.5523 13 29C13 28.4477 12.5523 28 12 28V30ZM25 12.5C25 13.0523 25.4477 13.5 26 13.5C26.5523 13.5 27 13.0523 27 12.5H25ZM10 6C9.44772 6 9 6.44772 9 7C9 7.55228 9.44772 8 10 8V6ZM22 8C22.5523 8 23 7.55228 23 7C23 6.44772 22.5523 6 22 6V8ZM10 11C9.44772 11 9 11.4477 9 12C9 12.5523 9.44772 13 10 13V11ZM22 13C22.5523 13 23 12.5523 23 12C23 11.4477 22.5523 11 22 11V13ZM10 16C9.44772 16 9 16.4477 9 17C9 17.5523 9.44772 18 10 18V16ZM13 18C13.5523 18 14 17.5523 14 17C14 16.4477 13.5523 16 13 16V18ZM22.5 23.5H21.5C21.5 23.7652 21.6054 24.0196 21.7929 24.2071L22.5 23.5ZM8 3H24V1H8V3ZM7 27V4H5V27H7ZM12 28H8V30H12V28ZM25 4V12.5H27V4H25ZM5 27C5 28.6569 6.34315 30 8 30V28C7.44771 28 7 27.5523 7 27H5ZM24 3C24.5523 3 25 3.44772 25 4H27C27 2.34315 25.6569 1 24 1V3ZM8 1C6.34315 1 5 2.34315 5 4H7C7 3.44772 7.44772 3 8 3V1ZM10 8H22V6H10V8ZM10 13H22V11H10V13ZM10 18H13V16H10V18ZM29 23.5C29 27.0899 26.0899 30 22.5 30V32C27.1944 32 31 28.1944 31 23.5H29ZM22.5 30C18.9101 30 16 27.0899 16 23.5H14C14 28.1944 17.8056 32 22.5 32V30ZM16 23.5C16 19.9101 18.9101 17 22.5 17V15C17.8056 15 14 18.8056 14 23.5H16ZM22.5 17C26.0899 17 29 19.9101 29 23.5H31C31 18.8056 27.1944 15 22.5 15V17ZM21.5 19V23.5H23.5V19H21.5ZM21.7929 24.2071L24.2678 26.682L25.682 25.2678L23.2071 22.7929L21.7929 24.2071Z",
        fill: t
      }
    )
  }
);
I5.displayName = "EmptyHistory";
const U5 = () => /* @__PURE__ */ C.jsxs("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
...
U5.displayName = "BonusLarge";
const $5 = () => /* @__PURE__ */ C.jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
...
$5.displayName = "BonusMedium";
const Y5 = () => /* @__PURE__ */ C.jsx("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ C.jsx(
  "path",
  {
    fillRule: "evenodd",
    clipRule: "evenodd",
...
Y5.displayName = "BonusSmall";
const G5 = () => /* @__PURE__ */ C.jsxs("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
      d: "M42 20C42 31.9135 28.9656 42.3787 25.0803 45.2335C24.4296 45.7115 23.5703 45.7115 22.9197 45.2335C19.0344 42.3787 6 31.9135 6 20C6 15.2261 7.89642 10.6477 11.2721 7.27208C14.6477 3.89642 19.2261 2 24 2C28.7739 2 33.3523 3.89642 36.7279 7.27208C40.1036 10.6477 42 15.2261 42 20Z",
...
G5.displayName = "CashoutLarge";
const J5 = () => /* @__PURE__ */ C.jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
      d: "M21 10C21 15.9567 14.4828 21.1893 12.5401 22.6167C12.2148 22.8558 11.7852 22.8558 11.4599 22.6167C9.51722 21.1893 3 15.9567 3 10C3 7.61305 3.94821 5.32387 5.63604 3.63604C7.32387 1.94821 9.61305 1 12 1C14.3869 1 16.6761 1.94821 18.364 3.63604C20.0518 5.32387 21 7.61305 21 10Z",
...
J5.displayName = "CashoutMedium";
const K5 = () => /* @__PURE__ */ C.jsx("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ C.jsx(
  "path",
  {
    fillRule: "evenodd",
    clipRule: "evenodd",
...
K5.displayName = "CashoutSmall";
const z5 = () => /* @__PURE__ */ C.jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
...
z5.displayName = "Check";
const X5 = () => /* @__PURE__ */ C.jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
      d: "M22.5 12C22.5 17.799 17.799 22.5 12 22.5C6.20101 22.5 1.5 17.799 1.5 12C1.5 6.20101 6.20101 1.5 12 1.5C17.799 1.5 22.5 6.20101 22.5 12Z",
...
X5.displayName = "Close";
const Q5 = () => /* @__PURE__ */ C.jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
      d: "M21 10C21 15.9567 14.4828 21.1893 12.5401 22.6167C12.2148 22.8558 11.7852 22.8558 11.4599 22.6167C9.51722 21.1893 3 15.9567 3 10C3 7.61305 3.94821 5.32387 5.63604 3.63604C7.32387 1.94821 9.61305 1 12 1C14.3869 1 16.6761 1.94821 18.364 3.63604C20.0518 5.32387 21 7.61305 21 10Z",
...
Q5.displayName = "DontWorkMedium";
const C9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
      d: "M42 20C42 31.9135 28.9656 42.3787 25.0803 45.2335C24.4296 45.7115 23.5703 45.7115 22.9197 45.2335C19.0344 42.3787 6 31.9135 6 20C6 15.2261 7.89642 10.6477 11.2721 7.27208C14.6477 3.89642 19.2261 2 24 2C28.7739 2 33.3523 3.89642 36.7279 7.27208C40.1036 10.6477 42 15.2261 42 20Z",
...
e9.displayName = "DontWorkSmall";
const l9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "48", height: "48", viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
      d: "M42 20C42 31.9135 28.9656 42.3787 25.0803 45.2335C24.4296 45.7115 23.5703 45.7115 22.9197 45.2335C19.0344 42.3787 6 31.9135 6 20C6 15.2261 7.89642 10.6477 11.2721 7.27208C14.6477 3.89642 19.2261 2 24 2C28.7739 2 33.3523 3.89642 36.7279 7.27208C40.1036 10.6477 42 15.2261 42 20Z",
...
t9.displayName = "TerminalMedium";
const r9 = () => /* @__PURE__ */ C.jsx("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ C.jsx(
  "path",
  {
...
r9.displayName = "TerminalSmall";
const i9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
      fillRule: "evenodd",
...
i9.displayName = "Clothing";
const H9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
...
H9.displayName = "ConstructionMaterials";
const s9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
      fillRule: "evenodd",
...
s9.displayName = "Food";
const n9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
...
n9.displayName = "Fridge";
const o9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
      fillRule: "evenodd",
...
o9.displayName = "Jewelry";
const d9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "rect",
    {
      x: "24.9561",
  ...
  /* @__PURE__ */ C.jsx("circle", { cx: "48.4229", cy: "80.3857", r: "4", fill: "#ECF0F3" }),
...
d9.displayName = "PhonesAndAccessories";
const a9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "rect",
    {
      x: "65",
...
a9.displayName = "Furniture";
const L9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
...
L9.displayName = "OneSomoni";
const c9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
...
c9.displayName = "DepositReplenishment";
const h9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
    ...
    /* @__PURE__ */ C.jsxs(
      "filter",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ C.jsx("feGaussianBlur", { in: "BackgroundImageFix", stdDeviation: "3.89062" }),
          /* @__PURE__ */ C.jsx("feComposite", { in2: "SourceAlpha", operator: "in", result: "effect1_backgroundBlur_4359_16588" }),
          /* @__PURE__ */ C.jsx(
            "feBlend",
            {
              mode: "normal",
...
const u9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  ...
  /* @__PURE__ */ C.jsx("g", { filter: "url(#filter0_b_4359_16587)", children: /* @__PURE__ */ C.jsx(
    "path",
    {
  ...
  /* @__PURE__ */ C.jsx("path", { d: "M44.1143 44.7407H68.1143", stroke: "#00AF66", strokeWidth: "4", strokeLinecap: "square" }),
  /* @__PURE__ */ C.jsx(
    "path",
    {
  ...
  /* @__PURE__ */ C.jsx("path", { d: "M44.1143 56.7407H68.1143", stroke: "#00AF66", strokeWidth: "4", strokeLinecap: "square" }),
  /* @__PURE__ */ C.jsx(
    "path",
    {
  ...
  /* @__PURE__ */ C.jsx("path", { d: "M44.1143 68.7407H68.1143", stroke: "#00AF66", strokeWidth: "4", strokeLinecap: "square" }),
  /* @__PURE__ */ C.jsx(
    "path",
    {
  ...
  /* @__PURE__ */ C.jsx("defs", { children: /* @__PURE__ */ C.jsxs(
    "filter",
    {
      ...
      children: [
        /* @__PURE__ */ C.jsx("feFlood", { floodOpacity: "0", result: "BackgroundImageFix" }),
        /* @__PURE__ */ C.jsx("feGaussianBlur", { in: "BackgroundImageFix", stdDeviation: "4.01481" }),
        /* @__PURE__ */ C.jsx("feComposite", { in2: "SourceAlpha", operator: "in", result: "effect1_backgroundBlur_4359_16587" }),
        /* @__PURE__ */ C.jsx(
          "feBlend",
          {
            mode: "normal",
...
u9.displayName = "Insurance";
const p9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
...
p9.displayName = "Investments";
const f9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
  ...
  /* @__PURE__ */ C.jsx("circle", { cx: "47.8671", cy: "52.4843", r: "32.7744", fill: "#ECF0F3" }),
  /* @__PURE__ */ C.jsx("circle", { cx: "47.8671", cy: "52.4843", r: "28.7744", fill: "#ECF0F3", stroke: "#00AF66", strokeWidth: "8" }),
  /* @__PURE__ */ C.jsx("path", { d: "M44.9443 35.0952H50.1498V54.7748H44.9443L44.9443 35.0952Z", fill: "#00AF66" }),
  /* @__PURE__ */ C.jsx("circle", { cx: "47.5468", cy: "54.2475", r: "4.33785", fill: "#48587D" }),
  /* @__PURE__ */ C.jsx(
    "path",
    {
...
f9.displayName = "Npl";
const V9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
  ...
  /* @__PURE__ */ C.jsx("circle", { cx: "68.1367", cy: "27.9102", r: "8", fill: "#00AF66" }),
...
const x9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  ...
  /* @__PURE__ */ C.jsx("path", { d: "M40.1143 38.7407H64.1143", stroke: "#00AF66", strokeWidth: "4", strokeLinecap: "square" }),
  /* @__PURE__ */ C.jsx(
    "path",
    {
  ...
  /* @__PURE__ */ C.jsx("path", { d: "M40.1143 50.7407H64.1143", stroke: "#00AF66", strokeWidth: "4", strokeLinecap: "square" }),
  /* @__PURE__ */ C.jsx(
    "path",
    {
  ...
  /* @__PURE__ */ C.jsx("path", { d: "M40.1143 62.7407H64.1143", stroke: "#00AF66", strokeWidth: "4", strokeLinecap: "square" }),
  /* @__PURE__ */ C.jsx(
    "path",
    {
...
x9.displayName = "DocumentExecution";
const w9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
  ...
  /* @__PURE__ */ C.jsx("rect", { x: "57.3213", y: "16.4375", width: "4", height: "4", rx: "1", fill: "#ECF0F3" }),
  /* @__PURE__ */ C.jsx("rect", { x: "66.1484", y: "16.4375", width: "4", height: "4", rx: "1", fill: "#ECF0F3" }),
  /* @__PURE__ */ C.jsx("rect", { x: "74.9756", y: "16.4375", width: "4", height: "4", rx: "1", fill: "#ECF0F3" }),
  /* @__PURE__ */ C.jsx(
    "path",
    {
...
w9.displayName = "Form";
const M9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx(
    "path",
    {
      fillRule: "evenodd",
  ...
  /* @__PURE__ */ C.jsx("circle", { cx: "43.791", cy: "53.1665", r: "13", fill: "#00AF66" }),
  /* @__PURE__ */ C.jsx(
    "circle",
    {
      cx: "3.25",
...
M9.displayName = "Money";
const v9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ C.jsx("circle", { cx: "48", cy: "48", r: "40", fill: "#ECF0F3" }),
  /* @__PURE__ */ C.jsx("circle", { cx: "48", cy: "48", r: "36", stroke: "#00AF66", strokeWidth: "8" }),
  /* @__PURE__ */ C.jsx("rect", { x: "45", y: "24.6082", width: "6", height: "24", fill: "#00AF66" }),
  /* @__PURE__ */ C.jsx("circle", { cx: "48", cy: "48", r: "5", fill: "#48587D" }),
  /* @__PURE__ */ C.jsx(
    "rect",
    {
      x: "46.7246",
...
const Z9 = () => /* @__PURE__ */ C.jsxs("svg", { width: "96", height: "96", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  ...
  /* @__PURE__ */ C.jsx("path", { d: "M43.1143 40.7407H67.1143", stroke: "#00AF66", strokeWidth: "4", strokeLinecap: "square" }),
  /* @__PURE__ */ C.jsx(
    "path",
    {
  ...
  /* @__PURE__ */ C.jsx("path", { d: "M43.1143 52.7407H67.1143", stroke: "#00AF66", strokeWidth: "4", strokeLinecap: "square" }),
  /* @__PURE__ */ C.jsx(
    "path",
    {
  ...
  /* @__PURE__ */ C.jsx("path", { d: "M43.1143 64.7407H67.1143", stroke: "#48587D", strokeWidth: "4", strokeLinecap: "square" }),
  /* @__PURE__ */ C.jsx(
    "path",
    {
...
Z9.displayName = "Valuation";
const g9 = ({ width: r = "41", height: l = "40" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: r,
    ...
    fill: "none",
    children: [
      /* @__PURE__ */ C.jsx("rect", { x: "0.496094", width: r, height: l, rx: "8", fill: "#111111" }),
      /* @__PURE__ */ C.jsx(
        "path",
        {
...
g9.displayName = "VKontakte";
const j9 = ({ width: r = "41", height: l = "40" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
    ...
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg",
    children: /* @__PURE__ */ C.jsxs("g", { id: "Frame 233", children: [
      /* @__PURE__ */ C.jsx("rect", { x: "0.16272", width: r, height: l, rx: "8", fill: "#111111" }),
      /* @__PURE__ */ C.jsx(
        "path",
        {
          id: "Vector",
...
j9.displayName = "LinkedIn";
const m9 = ({ width: r = "41", height: l = "40" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    width: r,
    height: l,
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      /* @__PURE__ */ C.jsx("g", { id: "Frame 235", clipPath: "url(#clip0_2149_382)", children: /* @__PURE__ */ C.jsxs("g", { id: "Group 71", children: [
        /* @__PURE__ */ C.jsx(
          "path",
          {
            id: "Vector",
      ...
      /* @__PURE__ */ C.jsx("defs", { children: /* @__PURE__ */ C.jsx("clipPath", { id: "clip0_2149_382", children: /* @__PURE__ */ C.jsx("rect", { width: r, height: l, fill: "white", transform: "translate(0.829468)" }) }) })
    ]
  }
);
m9.displayName = "Facebook";
const k9 = ({ width: r = "40", height: l = "40" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    width: r,
    height: l,
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      /* @__PURE__ */ C.jsxs("g", { clipPath: "url(#clip0_2070_395)", children: [
        /* @__PURE__ */ C.jsx(
          "path",
          {
        ...
        /* @__PURE__ */ C.jsx(
          "path",
          {
            d: "M28.9944 13.4554C28.7037 16.4419 27.4439 23.7 26.8043 27.0456C26.533 28.4632 25.9903 28.9358 25.4864 28.9925C24.3623 29.087 23.5095 28.2742 22.4241 27.5749C20.7186 26.4786 19.7495 25.7981 18.1021 24.7396C16.1834 23.511 17.4238 22.8306 18.5285 21.7343C18.8192 21.4508 23.7808 17.0467 23.8777 16.6498C23.8912 16.5897 23.8894 16.5272 23.8725 16.4679C23.8556 16.4087 23.8242 16.3543 23.7808 16.3095C23.6645 16.215 23.5095 16.2528 23.3738 16.2717C23.1994 16.3095 20.486 18.0674 15.1949 21.5453C14.4196 22.0556 13.7219 22.3202 13.1017 22.3013C12.404 22.2824 11.0861 21.9233 10.0976 21.602C8.87659 21.2239 7.9269 21.016 8.00443 20.3545C8.04319 20.0142 8.52773 19.674 9.43865 19.3149C15.098 16.9144 18.858 15.3267 20.738 14.5706C26.126 12.378 27.2307 12 27.9672 12C28.1222 12 28.4905 12.0378 28.7231 12.2268C28.9169 12.378 28.975 12.5859 28.9944 12.7372C28.975 12.8506 29.0138 13.1908 28.9944 13.4554Z",
            fill: "white"
          }
        )
      ] }),
      /* @__PURE__ */ C.jsx("defs", { children: /* @__PURE__ */ C.jsx("clipPath", { id: "clip0_2070_395", children: /* @__PURE__ */ C.jsx("rect", { width: r, height: l, fill: "white", transform: "translate(0.496094)" }) }) })
    ]
  }
);
k9.displayName = "Telegram";
const R9 = ({ width: r = "41", height: l = "40" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
    ...
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg",
    children: /* @__PURE__ */ C.jsxs("g", { id: "Frame 231", children: [
      /* @__PURE__ */ C.jsx("rect", { x: "0.496094", width: r, height: l, rx: "8", fill: "#111111" }),
      /* @__PURE__ */ C.jsx(
        "path",
        {
          ...
          fillRule: "evenodd",
          clipRule: "evenodd",
          d: "M28.6686 13.3275C28.6686 14.1561 27.9969 14.8275 27.1686 14.8275C26.3402 14.8275 25.6686 14.1561 25.6686 13.3275C25.6686 12.499 26.3402 11.8275 27.1686 11.8275C27.9971 11.8275 28.6686 12.499 28.6686 13.3275ZM20.4961 24.1666C18.1949 24.1666 16.3295 22.3012 16.3295 20C16.3295 17.6988 18.1949 15.8334 20.4961 15.8334C22.7973 15.8334 24.6627 17.6988 24.6627 20C24.6627 22.3012 22.7973 24.1666 20.4961 24.1666ZM20.4961 13.5811C16.951 13.5811 14.0771 16.4549 14.0771 20C14.0771 23.5451 16.951 26.4189 20.4961 26.4189C24.0412 26.4189 26.915 23.5451 26.915 20C26.915 16.4549 24.0412 13.5811 20.4961 13.5811ZM20.4961 9.75234C23.8338 9.75234 24.2291 9.76504 25.5471 9.8252C26.7658 9.88086 27.4277 10.0844 27.8682 10.2557C28.4516 10.4824 28.868 10.7533 29.3055 11.1908C29.743 11.6281 30.0139 12.0445 30.2406 12.6281C30.4117 13.0686 30.6154 13.7305 30.6711 14.9492C30.7312 16.2674 30.7439 16.6627 30.7439 20.0004C30.7439 23.3381 30.7312 23.7334 30.6711 25.0514C30.6154 26.2701 30.4119 26.932 30.2406 27.3725C30.0139 27.9559 29.743 28.3723 29.3055 28.8098C28.8682 29.2473 28.4518 29.5182 27.8682 29.7449C27.4277 29.916 26.7658 30.1197 25.5471 30.1754C24.2291 30.2355 23.8338 30.2482 20.4961 30.2482C17.1582 30.2482 16.7629 30.2355 15.4449 30.1754C14.2262 30.1197 13.5643 29.9162 13.1238 29.7449C12.5404 29.5182 12.124 29.2473 11.6865 28.8098C11.2492 28.3725 10.9781 27.9561 10.7514 27.3725C10.5803 26.932 10.3766 26.2701 10.3209 25.0514C10.2607 23.7332 10.248 23.3379 10.248 20.0004C10.248 16.6627 10.2607 16.2674 10.3209 14.9492C10.3766 13.7305 10.5801 13.0686 10.7514 12.6281C10.9781 12.0447 11.249 11.6283 11.6865 11.1908C12.1238 10.7533 12.5402 10.4824 13.1238 10.2557C13.5643 10.0846 14.2262 9.88086 15.4449 9.8252C16.7631 9.76504 17.1584 9.75234 20.4961 9.75234ZM20.4961 7.5C17.1014 7.5 16.6756 7.51445 15.3424 7.5752C14.0119 7.63594 13.1031 7.84727 12.3082 8.15625C11.4861 8.47559 10.7891 8.90312 10.0941 9.59805C9.39922 10.293 8.97168 10.99 8.65234 11.8121C8.34336 12.6072 8.13203 13.5158 8.07129 14.8463C8.01055 16.1795 7.99609 16.6053 7.99609 20C7.99609 23.3947 8.01055 23.8205 8.07129 25.1537C8.13203 26.4842 8.34336 27.3928 8.65234 28.1879C8.97168 29.01 9.39922 29.707 10.0941 30.402C10.7891 31.0969 11.4861 31.5242 12.3082 31.8437C13.1033 32.1527 14.0119 32.3641 15.3424 32.4248C16.6756 32.4855 17.1014 32.5 20.4961 32.5C23.8908 32.5 24.3166 32.4855 25.6498 32.4248C26.9803 32.3641 27.8889 32.1527 28.684 31.8437C29.5061 31.5242 30.2031 31.0969 30.898 30.402C31.593 29.707 32.0203 29.01 32.3398 28.1879C32.6488 27.3928 32.8602 26.4842 32.9209 25.1537C32.9816 23.8205 32.9961 23.3947 32.9961 20C32.9961 16.6053 32.9816 16.1795 32.9209 14.8463C32.8602 13.5158 32.6488 12.6072 32.3398 11.8121C32.0203 10.99 31.593 10.293 30.898 9.59805C30.2031 8.90312 29.5061 8.47578 28.684 8.15625C27.8889 7.84727 26.9803 7.63594 25.6498 7.5752C24.3166 7.51445 23.8908 7.5 20.4961 7.5Z",
          fill: "white"
        }
      )
    ] })
...
R9.displayName = "Instagram";
const y9 = ({ width: r = "41", height: l = "40" }) => /* @__PURE__ */ C.jsx(
  "svg",
  {
    width: r,
    height: l,
    ...
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg",
    children: /* @__PURE__ */ C.jsxs("g", { id: "Frame 230", children: [
      /* @__PURE__ */ C.jsx("rect", { x: "0.16272", width: r, height: l, rx: "8", fill: "#111111" }),
      /* @__PURE__ */ C.jsx("g", { id: "Group", children: /* @__PURE__ */ C.jsxs("g", { id: "Vector", children: [
        /* @__PURE__ */ C.jsx(
          "path",
          {
            fillRule: "evenodd",
            clipRule: "evenodd",
            d: "M17.5462 25.6628C16.5533 25.4322 15.6277 25.0988 14.7481 24.6461C14.433 24.4833 14.1228 24.309 13.8219 24.1218C12.9342 23.5676 12.6583 22.4242 13.1918 21.5445C13.7405 20.641 14.8777 20.3473 15.7856 20.8979C16.6787 21.4381 17.6251 21.8308 18.6535 22.0162C20.6771 22.3795 22.5784 22.0449 24.3501 21.0031C24.7116 20.7902 25.0768 20.6232 25.5081 20.6257C26.3444 20.6306 27.0766 21.1658 27.3195 21.9617C27.5636 22.7637 27.2595 23.6318 26.5493 24.0888C25.4426 24.8008 24.2442 25.3025 22.9681 25.6169C22.9131 25.6298 22.8592 25.6457 22.7821 25.6659C22.8341 25.7221 22.8745 25.7662 22.9173 25.809C24.0515 26.9432 25.1863 28.0755 26.3193 29.2115C26.9818 29.8759 27.1213 30.7874 26.6814 31.5472C26.0483 32.6416 24.5923 32.8233 23.6802 31.9167C22.5497 30.7923 21.4253 29.663 20.2991 28.5368C20.2587 28.4964 20.2208 28.453 20.1308 28.3551C20.0935 28.4218 20.0733 28.4866 20.0317 28.5282C18.903 29.6612 17.7744 30.7923 16.6408 31.9204C15.8633 32.6961 14.6759 32.6912 13.9234 31.9179C13.2352 31.2107 13.2156 30.0876 13.8812 29.3455C13.9711 29.244 14.069 29.1485 14.1644 29.0525C15.2472 27.9691 16.3294 26.8875 17.4122 25.8035C17.4495 25.7656 17.4881 25.7234 17.5462 25.6628Z",
            fill: "white"
          }
        ),
        /* @__PURE__ */ C.jsx(
          "path",
          {
            fillRule: "evenodd",
            clipRule: "evenodd",
            d: "M20.1648 7.5C23.716 7.5 26.6133 10.3985 26.6126 13.9497C26.612 17.5051 23.7423 20.3993 20.1673 20.4005C16.572 20.4042 13.717 17.5058 13.7115 13.9619C13.7054 10.4058 16.5824 7.50979 20.1648 7.5ZM22.8302 13.9558C22.8314 12.4864 21.6428 11.2879 20.1807 11.2843C18.6991 11.2806 17.4921 12.4686 17.4897 13.9319C17.4872 15.3977 18.6758 16.6181 20.1104 16.6193C21.6306 16.6206 22.829 15.4472 22.8302 13.9558Z",
            fill: "white"
          }
        )
      ] }) })
...
y9.displayName = "Odnoklassniki";
const F9 = ({ width: r = "41", height: l = "40" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    width: r,
    height: l,
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      /* @__PURE__ */ C.jsx("rect", { x: "0.829468", width: r, height: l, rx: "20", fill: "#111111" }),
      /* @__PURE__ */ C.jsx(
        "path",
        {
...
const B9 = ({ width: r = "40", height: l = "40" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    ...
    fill: "none",
    children: [
      /* @__PURE__ */ C.jsxs("g", { clipPath: "url(#clip0_2223_720)", children: [
        /* @__PURE__ */ C.jsx(
          "path",
          {
        ...
        /* @__PURE__ */ C.jsx("path", { d: "M15.501 12.5V27.5L28.0049 20L15.501 12.5Z", fill: "white" })
      ] }),
      /* @__PURE__ */ C.jsx("defs", { children: /* @__PURE__ */ C.jsx("clipPath", { id: "clip0_2223_720", children: /* @__PURE__ */ C.jsx("rect", { width: r, height: l, fill: "white", transform: "translate(0.496094)" }) }) })
    ]
  }
);
B9.displayName = "YouTube";
const _9 = ({ width: r = "121", height: l = "40" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: r,
    ...
    fill: "none",
    children: [
      /* @__PURE__ */ C.jsx("rect", { x: "0.496094", width: "120.001", height: "40", rx: "8", fill: "#111111" }),
      /* @__PURE__ */ C.jsx(
        "path",
        {
          d: "M27.2772 19.5856C27.2514 16.7207 29.623 15.3269 29.7314 15.262C28.3883 13.3037 26.3065 13.0362 25.575 13.0149C23.8265 12.8309 22.1305 14.0611 21.2398 14.0611C20.3314 14.0611 18.9598 13.0326 17.4815 13.0629C15.5793 13.0922 13.7997 14.1935 12.8237 15.9038C10.8095 19.3909 12.3117 24.5154 14.2415 27.3341C15.2069 28.7146 16.3349 30.2559 17.8113 30.2017C19.2558 30.1421 19.7954 29.2808 21.5385 29.2808C23.2656 29.2808 23.7723 30.2017 25.2781 30.167C26.8283 30.1421 27.8043 28.7803 28.7359 27.3874C29.8514 25.8052 30.2995 24.247 30.3172 24.167C30.2808 24.1545 27.3065 23.0194 27.2772 19.5856Z",
          fill: "white"
        }
      ),
      /* @__PURE__ */ C.jsx(
        "path",
        {
          d: "
z",
          fill: "white"
        }
      ),
      /* @__PURE__ */ C.jsx(
      ...
      /* @__PURE__ */ C.jsx(
        "path",
        {
          d: "M94.4446 21.5203C94.4446 22.8314 94.0695 23.9079 93.321 24.7497C92.5361 25.6163 91.4943 26.0483 90.1957 26.0483C88.9441 26.0483 87.9476 25.6332 87.2045 24.803C86.4614 23.9728 86.0898 22.9248 86.0898 21.6616C86.0898 20.3398 86.4721 19.2572 87.2392 18.4154C88.0045 17.5727 89.0374 17.1514 90.3361 17.1514C91.5877 17.1514 92.5948 17.5665 93.3548 18.3976C94.0819 19.2038 94.4446 20.2447 94.4446 21.5203ZM92.4783 21.5816C92.4783 20.795 92.3103 20.1203 91.9699 19.5576C91.5726 18.8767 91.0046 18.5372 90.2685 18.5372C89.5068 18.5372 88.9281 18.8776 88.5308 19.5576C88.1903 20.1212 88.0223 20.8065 88.0223 21.6172C88.0223 22.4039 88.1903 23.0785 88.5308 23.6403C88.9405 24.3212 89.513 24.6608 90.2517 24.6608C90.9752 24.6608 91.5432 24.3141 91.953 23.6225C92.3023 23.0492 92.4783 22.3674 92.4783 21.5816Z",
          fill: "white"
        }
      ),
      /* @__PURE__ */ C.jsx(
        "path",
        {
          d: "M100.607 18.9922C100.419 18.9575 100.219 18.9397 100.009 18.9397C99.3426 18.9397 98.827 19.1913 98.4643 19.6953C98.1488 20.1398 97.9905 20.7015 97.9905 21.3798V25.8554H96.0963L96.1141 20.0118C96.1141 19.0286 96.0901 18.1335 96.043 17.3264H97.6937L97.763 18.9584H97.8154C98.0154 18.3975 98.331 17.946 98.763 17.6073C99.1852 17.3024 99.6412 17.1504 100.133 17.1504C100.308 17.1504 100.466 17.1628 100.607 17.1851V18.9922Z",
          fill: "white"
        }
      ),
      /* @__PURE__ */ C.jsx(
        "path",
        {
          d: "M109.081 21.1872C109.081 21.5268 109.058 21.813 109.011 22.0468H103.326C103.348 22.8895 103.623 23.5339 104.151 23.9784C104.63 24.3757 105.249 24.5748 106.01 24.5748C106.852 24.5748 107.62 24.4406 108.311 24.1713L108.608 25.4868C107.801 25.8389 106.848 26.014 105.748 26.014C104.425 26.014 103.387 25.6246 102.632 24.8468C101.878 24.0691 101.5 23.0246 101.5 21.7144C101.5 20.4281 101.851 19.357 102.554 18.5028C103.29 17.5908 104.285 17.1348 105.536 17.1348C106.766 17.1348 107.697 17.5908 108.329 18.5028C108.829 19.2272 109.081 20.1232 109.081 21.1872ZM107.273 20.6957C107.286 20.1339 107.162 19.6486 106.905 19.2388C106.577 18.7117 106.073 18.4486 105.395 18.4486C104.776 18.4486 104.272 18.7054 103.887 19.221C103.571 19.6308 103.384 20.1223 103.326 20.6948H107.273V20.6957Z",
          fill: "white"
        }
      )
    ]
...
_9.displayName = "AppleAppStore";
const E9 = ({ width: r = "136", height: l = "40" }) => /* @__PURE__ */ C.jsxs(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: r,
    ...
    fill: "none",
    children: [
      /* @__PURE__ */ C.jsx("rect", { x: "0.497314", width: "136", height: "40", rx: "6", fill: "#111111" }),
      /* @__PURE__ */ C.jsx(
        "path",
        {
          d: "
.379V23.9497H98.0654V19.7781H100.373C102.237 19.7781 104.012 18.4467 104.012 16.3166C104.012 14.1864 102.237 12.855 100.373 12.855ZM100.462 18.1805H98.0654V14.3639H100.462C101.704 14.3639 102.414 15.429 102.414 16.2278C102.326 17.2041 101.616 18.1805 100.462 18.1805ZM110.669 16.5828C109.426 16.5828 108.184 17.1154 107.74 18.2692L109.249 18.8905C109.604 18.2692 110.136 18.0917 110.758 18.0917C111.645 18.0917 112.444 18.6243 112.533 19.5118V19.6006C112.267 19.4231 111.556 19.1568 110.846 19.1568C109.249 19.1568 107.651 20.0444 107.651 21.642C107.651 23.1509 108.983 24.1272 110.403 24.1272C111.556 24.1272 112.089 23.5947 112.533 23.0621H112.622V23.9497H114.219V19.6893C114.042 17.7367 112.533 16.5828 110.669 16.5828ZM110.491 22.7071C109.959 22.7071 109.16 22.4408 109.16 21.7308C109.16 20.8432 110.136 20.5769 110.935 20.5769C111.645 20.5769 112 20.7544 112.444 20.932C112.267 21.997 111.379 22.7071 110.491 22.7071ZM119.811 16.8491L117.947 21.642H117.858L115.906 16.8491H114.13L117.059 23.5947L115.373 27.3225H117.059L121.586 16.8491H119.811ZM104.9 23.9497H106.586V12.855H104.9V23.9497Z",
          fill: "white"
        }
      ),
      /* @__PURE__ */ C.jsx(
        "path",
        {
          d: "M25.195 19.4001L14.595 30.7001C14.895 31.9001 15.995 32.8001 17.395 32.8001C17.895 32.8001 18.395 32.7001 18.895 32.4001L30.895 25.5001L25.195 19.4001Z",
          fill: "#EA4335"
        }
      ),
      /* @__PURE__ */ C.jsx(
        "path",
        {
          d: "M35.9973 17.5L30.7973 14.5L24.9973 19.7L30.7973 25.5L35.8973 22.5C36.7973 22 37.3973 21.1 37.3973 20C37.4973 18.9 36.8973 18 35.9973 17.5Z",
          fill: "#FBBC04"
        }
      ),
      /* @__PURE__ */ C.jsx(
        "path",
        {
          d: "M14.5973 9.29956C14.4973 9.49956 14.4973 9.79956 14.4973 9.99956V29.9996C14.4973 30.2996 14.4973 30.4996 14.5973 30.6996L25.5973 19.6996L14.5973 9.29956Z",
          fill: "#4285F4"
        }
      ),
      /* @__PURE__ */ C.jsx(
        "path",
        {
          d: "M25.2973 20L30.7973 14.5L18.7973 7.59995C18.3973 7.29995 17.8973 7.19995 17.2973 7.19995C15.9973 7.19995 14.7973 8.09995 14.4973 9.29995L25.2973 20Z",
          fill: "#34A853"
        }
      )
    ]
...
E9.displayName = "GooglePlay";
export {
  d2 as Analytics,
  _9 as AppleAppStore,
  E2 as ArrowDown,
  N2 as ArrowUp,
  M9 as AutoCreditMoney,
  a2 as Bank,
  B2 as Banknote,
  T5 as Bell,
  z2 as Bill,
  ...
  X5 as CloseCircle,
  i9 as Clothing,
  H9 as ConstructionMaterials,
  n5 as Copy,
  h2 as CreditCard,
  _2 as CrossedBanknote,
  u2 as CurrencyDollar,
  p2 as CurrencyLira,
  f2 as CurrencyRuble,
  o5 as Delete,
  c9 as DepositReplenishment,
  d5 as Doc,
  a5 as DocEmpty,
  x9 as DocumentExecution,
  V2 as Dollar,
  Q5 as DontWorkLarge,
  C9 as DontWorkMedium,
  e9 as DontWorkSmall,
  L5 as Edit,
  I5 as EmptyHistory,
  c5 as Expand,
